...
$(function () {
  ...
  // Dark sidebar skins
  var $skinBlue =
        $('<li />', { style: 'float:left; width: 100%; padding: 5px;' })
          .append('<a href="javascript:void(0)" data-skin="skin-blue" style="display: block; box-shadow: 0 0 3px rgba(0,0,0,0.4)" class="clearfix full-opacity-hover">'
            + '<div><span style="display:block; width: 20%; float: left; height: 7px; background:#0f9ad8"></span><span style="display:block; width: 80%; float: left; height: 7px; background:#0a89c1;"></span></div>'
  ...
  var $skinGreen =
        $('<li />', { style: 'float:left; width: 100%; padding: 5px;' })
          .append('<a href="javascript:void(0)" data-skin="skin-green" style="display: block; box-shadow: 0 0 3px rgba(0,0,0,0.4)" class="clearfix full-opacity-hover">'
            + '<div><span style="display:block; width: 20%; float: left; height: 7px; background: #27a768" ></span><span style="display:block; width: 80%; float: left; height: 7px; background: #33bf7a"></span></div>'
            + '<div><span style="display:block; width: 20%; float: left; height: 20px; background: #ffffff"></span><span style="display:block; width: 80%; float: left; height: 20px; background: #eef5f9"></span></div>'
            + '</a>'
  ...
  var $skinRed =
        $('<li />', { style: 'float:left; width: 100%; padding: 5px;' })
          .append('<a href="javascript:void(0)" data-skin="skin-red" style="display: block; box-shadow: 0 0 3px rgba(0,0,0,0.4)" class="clearfix full-opacity-hover">'
            + '<div><span style="display:block; width: 20%; float: left; height: 7px; background: #e83636" ></span><span style="display:block; width: 80%; float: left; height: 7px; background: #f95454"></span></div>'
            + '<div><span style="display:block; width: 20%; float: left; height: 20px; background: #ffffff"></span><span style="display:block; width: 80%; float: left; height: 20px; background: #eef5f9"></span></div>'
            + '</a>'
  ...
  var $skinYellow =
        $('<li />', { style: 'float:left; width: 100%; padding: 5px;' })
          .append('<a href="javascript:void(0)" data-skin="skin-yellow" style="display: block; box-shadow: 0 0 3px rgba(0,0,0,0.4)" class="clearfix full-opacity-hover">'
            + '<div><span style="display:block; width: 20%; float: left; height: 7px; background: #dfa606" ></span><span style="display:block; width: 80%; float: left; height: 7px; background: #efb614"></span></div>'
            + '<div><span style="display:block; width: 20%; float: left; height: 20px; background: #ffffff"></span><span style="display:block; width: 80%; float: left; height: 20px; background: #eef5f9"></span></div>'
            + '</a>'
